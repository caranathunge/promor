...
## Data
For this tutorial we will be using a previously published data set from [Suvarna et al. (2021)](https://www.frontiersin.org/articles/10.3389/fphys.2021.652799/full#h3). In this study, authors used differentially expressed proteins between **33 severe** and **18 non-severe** COVID patients to build models to predict COVID severity.

## Workflow
![promor for modeling flowchart by caranathunge](../man/figures/promor_ProtModelingFlowChart_small.png) 
...
**You can access the help pages for functions shown above and more using** `?function name`
...
#Create a model_df object with the top 10 differentially expressed proteins.
...
```{r traindata, warning = FALSE, message = F}
...
covid_model_list_1 <- train_models(split_df = covid_split_df, 
                                   algorithm_list = c("glmnet", "svmRadial"))
```
