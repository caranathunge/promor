...
knitr::include_graphics("../promor_ProtAnalysis_BluYe.png")
```
...
```{r volcanoplot, warning = FALSE, dpi = 300, out.width = '100%', fig.align ='center'}
 volcano_plot(fit_df)
```
...
1. If your data does NOT contain technical replicates, you can refer to the 
following tutorial.
...
2. If your data contains technical replicates, you can refer to the following 
