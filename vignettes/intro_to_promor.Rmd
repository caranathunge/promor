...
* `promor` provides a range of quality control and visualization tools at the 
...
file produced by [**MaxQuant**](https://maxquant.org) and an [expDesign.txt](https://raw.githubusercontent.com/caranathunge/promor_example_data/main/ed1.txt) file, which contains the 
