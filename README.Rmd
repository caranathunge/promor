...
learning-based modeling. The input for *promor* is the *proteinGroups.txt* 
...
expressed proteins between multiple conditions with five simple steps in *promor*. 
...
-   If your data does NOT contain technical replicates, you can refer to the 
following tutorial.
...
-   If your data contains technical replicates, you can refer to the following 
...
-   If you would like to perform modeling with specific proteins from your data 
set to test their predictive performance, you may refer to the following tutorial.
...
-   [promor](http://promor.html) Will add these to a github repository and link 
them here later


#### Citation

[Journal](https://www.blabla) Link to preprint or actual article once this is 
published
