...
```{r volcanoplot, warning = FALSE, dpi = 300, out.width = '90%', fig.align ='center'}
 volcano_plot(fit_df)
```
...
![promor flowchart-modeling by caranathunge](./promor_ProtModelingFlowChart.png) 
...
We use a previously published data set from [Suvarna et al. (2021)](https://www.frontiersin.org/articles/10.3389/fphys.2021.652799/full#h3) that used differentially expressed proteins between severe and non-severe COVID patients to build predictive medict COVID severity.
...
2. If your data does NOT contain technical replicates, you can refer to the 
following tutorial.
...
3. If your data contains technical replicates, you can refer to the following 
tutorial for an illustrative example.

``` r
vignette("promor_with_techreps", package = "promor")
```

4. If you would like to use your proteomics data to build predictive models, you can follow this tutorial.
