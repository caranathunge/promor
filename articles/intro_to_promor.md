...
![](../reference/figures/promor_ProtAnalysisFlowChart_small.png)
...
We use a previously published data set from [Cox et
...
![](../reference/figures/promor_ProtModelingFlowChart_small.png)
...
1.  If your data do NOT contain technical replicates: [promor: No
    technical
    replicates](https://caranathunge.github.io/promor/articles/promor_no_techreps.html)

2.  If your data contains technical replicates: [promor: Technical
    replicates](https://caranathunge.github.io/promor/articles/promor_with_techreps.html)

3.  If you would like to use your proteomics data to build predictive
    models: [promor:
