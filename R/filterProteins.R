...
# Filter missing data -----------------------------------------------------
#This function removes proteins (rows) that are absent (NA) across all samples 
#and samples (columns) with no protein data
...
#This function filters out proteins with >33% NA in each group
...
#Optional: This function outputs a list of proteins absent in one group 
#and present in more than 66% samples in the other group. 
#Currently, best suited for 2 groups
