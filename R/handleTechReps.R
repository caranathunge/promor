...
#This function makes scatter plots to visualize the correlation between 
# a given pair of technical replicates (1 vs 2) for all samples
...
#This function removes user-specified samples (columns) from the database
...
#This function computes average intensities across tech.replicates
